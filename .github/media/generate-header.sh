#!/bin/bash
# Regenerates .github/media/rackscreen-header.png (the README header card).
#
# Adapted from https://github.com/resend/n8n-nodes-resend/blob/main/.github/media/generate-header.sh (MIT).
#
# Prerequisites:
...
TITLE="${TITLE:-RackScreen}"
SUBTITLE="${SUBTITLE:-Animated Kubernetes monitor for four round displays on a Raspberry Pi}"
ICON="${ICON:-$HERE/rackscreen-icon.svg}"
...
OUT="${OUT:-$HERE/rackscreen-header.png}"
SEED="${SEED:-42}"
